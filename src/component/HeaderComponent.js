        ...
        <nav class="navbar bg-body- ">
          {this.props.authenticated ? (
            <div class="container-fluid">
              ...
              <span class="me-auto text1">
                “Enjoy your delicious meal with a side of smiles”
              </span>
              ...
              <div class="d-flex">
                ...
                <Button
                  href="https://donate.stripe.com/test_bIYg1kc8y2hBg9OcMN"
            ...
            <div class="container-fluid">
              ...
              <div class="d-flex">
                <Button href="/login" className="btn btn-info me-2">
                  Login
                </Button>
            ...
            <Row className="justify-content-md-center">
              ...
              <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="me-auto ">
                  ...
                  <Col xs lg="4">
                    <Nav.Link id="h" href="/about">
                      ABOUT
                    </Nav.Link>
                  </Col>

                  <Col xs lg="4">
                    <Nav.Link id="h" href="/contact">
                      CONTACT
                    </Nav.Link>
                  </Col>
                </Nav>
